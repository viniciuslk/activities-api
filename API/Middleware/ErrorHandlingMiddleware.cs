...
namespace API.Middleware
{
    public class ErrorHandlingMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            {
                await HandleExceptionAcync(context, ex, _logger);
            }
        }

        private async Task HandleExceptionAcync(HttpContext context, Exception exception, ILogger<ErrorHandlingMiddleware> logger)
        {
            object errors = null;
